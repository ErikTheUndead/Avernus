...
public class DaoCompteImpl implements IDaoCompte {
	 ...
	 * (non-Javadoc)
	 * 
	 * @see com.myapp.gestiondecompte.dao.compte.IDaoCompte#addCompte(com.myapp.
	 * gestiondecompte.entities.Compte)
	 */
	...
	public Compte addCompte(Compte c, Long idClient, Long idEmploye, Long idBanque) throws ExceptionPerso {
		...
		ss.close();
		logger.info("le compte " + c.getIdCompte() + " á bien été enregistré : " + c.getClient().getIdClient() + "");
		return c;
	}
	 ...
	 * 
	 * @see
	 * com.myapp.gestiondecompte.dao.compte.IDaoCompte#deleteCompte(java.lang.
	 * Long)
	 */
	 ...
	 * 
	 * @see
	 * com.myapp.gestiondecompte.dao.compte.IDaoCompte#updateCompte(com.myapp.
	 * gestiondecompte.entities.Compte)
	 */
	 ...
	 * 
	 * @see
	 * com.myapp.gestiondecompte.dao.compte.IDaoCompte#getCompteEmploye(java.
	 * lang.Long)
	 */
	...
	public List<Compte> getCompteEmploye(Long idEmploye) throws ExceptionPerso {
		...
		// String hql = "FROM Compte c INNER JOIN c.employe e WHERE e.idEmploye
		// =:l";
	 ...
	 * 
	 * @see
	 * com.myapp.gestiondecompte.dao.compte.IDaoCompte#getCompteId(java.lang.
	 * Long)
	 */
