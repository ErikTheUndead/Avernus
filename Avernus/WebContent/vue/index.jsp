		...
		<div class="container">
			...
			<div
				...
				<ul class="nav navbar-nav">
					...
					<li><a class="page-scroll" href="#compte">Comptes</a></li>
					<li><a class="page-scroll" href="#operation">Opérations</a></li>
					<li><a class="page-scroll" href="#employe">Employés</a></li>
					<li><a class="page-scroll" href="#groupe">Groupes</a></li>
					<li><a class="page-scroll" href="#banque">Banques</a></li>
				</ul>
			</div>
			<!-- /.navbar-collapse -->
		</div>
